  ...
  <Card class="bg-teal-light p-10">
    <div class="flex flex-col justify-center items-center gap-4 text-black text-lg">
      <div class="flex flex-col justify-center items-center">
        <div>Sending <span>18.00</span> <span>DAI</span></div>
        <div>from <span>Goerli</span></div>
        <div>to <span>Goerli</span></div>
      </div>
      <div class="flex flex-col justify-center items-center">
        <div>Recipient address</div>
        <div>0x1111111111111111111111111111111</div>
      </div>
    </div>
  </Card>
  <div class="flex flex-col justify-center items-center">
    <div>
      <ul class="steps steps-vertical">
        ...
        <li data-content="" class="step step-success">Request is being fulfilled</li>
